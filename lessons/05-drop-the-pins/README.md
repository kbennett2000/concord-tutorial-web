...
can locate, and honestly leave off the ones it can't. This is also the first time the app
reaches the internet (map tiles come from online) — we'll explain that tradeoff plainly. You
